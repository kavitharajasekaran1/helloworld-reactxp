...
onChangedigitgo=() =>{
    this.props.onNavigatedigitgo(liability,resJson,message,quoteid,premium,odpremium,token,responseJson1,idv,enquiryId,totalGrossPremium,TotalPremium)
}
    onChangeliability = () => {
        var input= new Array()
        input[1]=this.refs.check_me1.checked;
        ...
        input[2]=this.refs.check_me2.checked;
        console.log(this.refs.check_me2.checked)
    ...
    // var checkme=input[1] || input[2] || input[3] || input[4]||input[5] ;

    // console.log(checkme,"checkmeeee")
...
// swal("please select any one of the option") }
if(count<=1)
        {swal("please select atleast two option")}
else {
    this.props.onNavigateSixth(liability,resJson,message,quoteid,premium,odpremium,token,responseJson1,idv,enquiryId,totalGrossPremium);
      ...
      if(this.refs.check_me4.checked)
      {
          global.index3=1
      }

      if(this.refs.check_me5.checked)
      {
          global.index4=1
      }
    ...
    // console.log("totalpremuim", totalGrossPremium)
        ...
        return (
            ...
            <RX.Button   onPress={()=> this.onChangePost()}><RX.Image
                ...
                <RX.View style={ _styles.pageAlign }>
                    <RX.View style={ _styles.client }>
                        <RX.Image source={ './src/img/digit.jpg' } style={ [_styles.icic] } >
                        ...
                        <RX.Text style={ _styles.ncb }>
                            <div>Rs. {idv}</div>
                            {/* <div>Rs.58,567</div> */}
                            <div>{totalGrossPremium}</div>
                            {/* <div>2490</div> */}
                        </RX.Text>
                        <RX.View style={_styles.nextBtn}>
                            <RX.Button style={ _styles.roundButton } onPress={ () => this.onChangedigitgo() }>
                                <RX.Text style={ _styles.buybuttonText }>
