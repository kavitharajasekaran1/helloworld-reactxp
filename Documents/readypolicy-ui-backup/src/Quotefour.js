...
const styles = {
    ...
    /* sideHead: RX.Styles.createScrollViewStyle({
     ...
     tryHead: RX.Styles.createScrollViewStyle({
         ...
         color: '#3e376d',
         textTransform:'capitalize'
     }),*/BUTTON4s :RX.Styles.createViewStyle({
        display: 'block',
        width: '12%',
        height: 41,
        justifyContent: 'center',
   ...
   BUTTON4e :RX.Styles.createViewStyle({
    display: 'block',
    width: '12%',
    height: 41,
    justifyContent: 'center',
                ...
                <RX.View style={styles.clientSec}>
                  <Row className="show-grid hidden-xs">
                        ...
                        {this.state.showme1 ? <Col  md={3} style={styling.marTop}>
                            ...
                            <RX.Image source={ './src/img/digit.jpg' } style={ [styles.image] } />
                            {/*<RX.Image source={ './src/img/Bharti.png' } style={ [styles.image ] } />*/}
                        </Col>:null}
                    ...
                    <Row className="show-grid hidden-xs">
                        ...
                        {this.state.showme1 ?  <Col  md={3} style={styling.marTop}>
                            <RX.Text style={[styles.clientText]}>Digitgo Insurance</RX.Text>
                        </Col>:null}
                        {this.state.showme2 ? <Col  md={3} style={styling.marTop}>
                   ...
                   <Col  md={3} style={styling.marTopcs}>
                        ...
                        {this.state.showme1? <Col  md={3} style={styling.marTop}>
                            <RX.Text style={[styles.subText]}>702</RX.Text>
                        </Col>:null}
                        {this.state.showme2 ?<Col  md={3} style={styling.marTop}>
                  ...
                  <Col  md={3} style={styling.marTopcs}>
                        ...
                        {this.state.showme1 ?<Col  md={3} style={styling.marTop}>
                            <RX.Text style={[styles.subText]}>46</RX.Text>
                        </Col>:null}
                        {this.state.showme2 ? <Col  md={3} style={styling.marTop}>
                            <RX.Text style={[styles.subText]}>1340</RX.Text>
                        </Col>:null}
                    </Row>
                    ...
                    <Row className="show-grid hidden-xs">
                        ...
                        {this.state.showme1 ?  <Col  md={3} style={styling.marTop}>
                            <RX.Text style={[styles.subText]}>1240</RX.Text>
                        </Col>:null}
                        {this.state.showme2 ?  <Col  md={3} style={styling.marTop}>
                    ...
                    <Row className="show-grid hidden-xs">
                       ...
                       {this.state.showme1 ?   <Col  md={3} style={styling.marTop}>
                            <RX.Text style={[styles.subText]}>135</RX.Text>
                        </Col>:null}
                        {this.state.showme2?   <Col  md={3} style={styling.marTop}>
                    ...
                    <Row className="show-grid hidden-xs">
                        ...
                        {this.state.showme1 ? <Col  md={3} style={styling.marTop}>
                            <RX.Text style={[styles.subText]}>60</RX.Text>
                        </Col>:null}
                          {this.state.showme2 ?<Col  md={3} style={styling.marTop}>
                            <RX.Text style={[styles.subText]}>Nil</RX.Text>
                        </Col>:null}
...
:
                         ...
                         {this.state.showme1 ? <Col  md={3} style={styling.marTop}>
                            <RX.Text style={[styles.subText]}>0</RX.Text>
                        </Col>:null}
                        {this.state.showme2 ?<Col  md={3} style={styling.marTop}>
                            <RX.Text style={[styles.subText]}>Nil</RX.Text>
                        </Col>:null}
                    ...
                    <Row className="show-grid hidden-xs">
                        ...
                        {this.state.showme ? <Col  md={3} style={styling.marTop}>
                          ...
                          {this.state.showme1 ?<Col  md={3} style={styling.marTop}>
                            <RX.Text style={[styles.subText]}>80</RX.Text>
                        </Col>:null}
                        {this.state.showme2 ?<Col  md={3} style={styling.marTop}>
                            <RX.Text style={[styles.subText]}>Nil</RX.Text>
                        </Col>:null}
                ...
                {this.state.showme ? <RX.Button style={[styles.BUTTON4s]}  onPress={()=> this.onChangePostCompare() }>
...
<RX.Text style={ styles.buttonText }>
    Buy Policy
              ...
              {this.state.showme1 ? <RX.Button style={[styles.BUTTON4e]}  onPress={()=> this.onChangePostCompare() }>
